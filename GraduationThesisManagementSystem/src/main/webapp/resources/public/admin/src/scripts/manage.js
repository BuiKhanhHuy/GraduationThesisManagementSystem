...
const showAddManageModal = (appContext) => {
    ...
    document.getElementById("password-area").innerHTML = `<label class="font-weight-bold">Mật khẩu<span
...
const showEditManageModal = (appContext, manageId) => {
    ...
    loadManageById(endpoint, (data) => {
        ...
        document.getElementById("btn-submit-form").onclick = () => saveChange(appContext, manageId)
        $('#modal-add-edit-manage').modal()
