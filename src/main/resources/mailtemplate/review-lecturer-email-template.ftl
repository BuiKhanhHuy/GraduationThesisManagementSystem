...
<table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
       style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e2eace;" width="100%">
    <tbody>
    <tr>
        <td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                            alt="Image"
                                                            src="https://res.cloudinary.com/dtnpj540t/image/upload/v1658598874/asqtbyhdunc0eawri28d.png"
                                                            style="display: block; height: auto; border: 0; width: 150px; max-width: 100%;"
                                                            title="Image" width="150"/></div>
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            <td class="pad">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                        ...
                                                        <p style="margin: 0; font-size: 14px; text-align: center;">He
                                                            thong quan ly khoa luan tot nghiep</p>
                                                        <p style="margin: 0; font-size: 14px; text-align: center;">
                                                            Trường Đại học Mở Thành phố Hồ Chí Minh</p>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-1"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                ...
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #0D0D0D; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                        <p style="margin: 0; font-size: 14px; text-align: center;"><span
                                                                    style="font-size:30px;"><strong><span style="">Xin chào <span
                                                                                style="color:#1a00ff;">
                                      <#if (thesis.reviewLecturer)??>
                                          ${thesis.reviewLecturer.fullName}
                                      </#if>
                                    </span>,</span></strong></span><br/><span style="color:#000000;"><span
                                                                        style="font-size:28px;">Đồng chí đã được nhà trường </span><span
                                                                        style="font-size:28px;">phân công nhiệm vụ phản biện </span><span
                                                                        style="font-size:28px;">khóa luận tốt nghiệp</span></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-2"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                style="width:100%;padding-bottom:15px;padding-right:0px;padding-left:0px;">
                                                <div align="center" class="alignment" style="line-height:10px"><img
                                                            alt="Image"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-3"
                                        ...
                                        <tr>
                                            <td class="pad"
                                                style="padding-bottom:10px;padding-left:25px;padding-right:25px;padding-top:40px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 12px; mso-line-height-alt: 18px; color: #0D0D0D; line-height: 1.5; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                        <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 24px;">
                                                            <span style="font-size:16px;"><strong>ĐỀ TÀI</strong>:<span
                                                                        style="color:#1a00ff;"><strong> <span
                                                                                style="color:#e40f0f;">
                                                                            <#if (thesis.topic)??>
                                                                                ${thesis.topic.name}
                                                                            </#if>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="list_block block-4"
                                           role="presentation"
                                           style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;"
                                           width="100%">
                                        <tr>
                                            <td class="pad"
                                                style="padding-bottom:30px;padding-left:60px;padding-right:50px;padding-top:10px;">
                                                <ul style="margin: 0; padding: 0; margin-left: 20px; list-style-type: revert; color: #000000; font-size: 14px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; font-weight: 400; line-height: 200%; text-align: left; direction: ltr; letter-spacing: 0px;">
                                                    <li style="margin-bottom: 0px;">Giảng viên hướng dẫn:
                                                        <#if (thesis.lecturers)??>
                                                            <#list thesis.lecturers as lecturer>
                                                                <strong> ${lecturer.fullName}</strong>,
                                                            </#list>
                                                        </#if>
                                                    </li>
                                                    <li style="margin-bottom: 0px;">Sinh viên thực hiện:
                                                        <#if (thesis.students)??>
                                                            <#list thesis.students as student>
                                                    ...
                                                    <li style="margin-bottom: 0px;">Ngày kết thúc:
                                                        <#if (thesis.complateDate)??>
                                                            <strong>${thesis.complateDate}</strong>
                                                        </#if>
                                                    </li>
                                                    ...
                                                    <li>Niên khóa:
                                                        <#if (thesis.schoolYear)??>
                                                            <strong>${thesis.schoolYear.name}</strong>
                                                        </#if>
                                                    </li>
                                                </ul>
                                            </td>
                                            ...
                                            <td class="pad">
                                                <div align="center" class="alignment">
                                                    ...
                                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                                 ...
                                                                 style="height:48px;width:247px;v-text-anchor:middle;"
                                                                 arcsize="9%" stroke="false" fillcolor="#3AAEE0">
                                                        <w:anchorlock/>
                                                        <v:textbox inset="0px,0px,0px,0px">
                                                            <center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:14px">
                                                    <![endif]-->
                                                    <div style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#3AAEE0;border-radius:4px;width:auto;border-top:1px solid #3AAEE0;font-weight:400;border-right:1px solid #3AAEE0;border-bottom:1px solid #3AAEE0;border-left:1px solid #3AAEE0;padding-top:10px;padding-bottom:10px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                        <span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;"><span
                                                                    dir="ltr"
                                                                    style="word-break: break-word; line-height: 28px;">XEM THÔNG TIN CHI TIẾT</span></span>
                                                    </div>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-4" role="presentation"
                ...
                <tr>
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
                               role="presentation"
                               style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #525252; color: #000000; width: 600px;"
                               width="600">
                            <tbody>
                            <tr>
                                <td class="column column-1"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" class="text_block block-2"
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-top:25px;padding-bottom:5px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #a8bf6f; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                        <p style="margin: 0; font-size: 12px; text-align: center;"><span
                                                                    style="color:#ffffff;font-size:12px;"><span
                                                                        style="font-size:12px;color:#a8bf6f;">Tel:</span> 0888.425.094</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="pad" style="padding-top:25px;padding-bottom:5px;">
                                                <div style="font-family: sans-serif">
                                                    <div class="txtTinyMce-wrapper"
                                                         style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #a8bf6f; line-height: 1.2; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;">
                                                        <p style="margin: 0; font-size: 12px; text-align: center;">Email
                                                            <span style="color:#ffffff;font-size:12px;">hethongquanlykhoaluan.hcmcou@gmail.com</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </td>
