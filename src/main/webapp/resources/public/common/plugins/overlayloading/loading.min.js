...
!function (a) {
    ...
    c["line-pulse"] = function () {
    ...
    }, c["jump-pulse"] = function () {
        for (var a = c.top({width: "100", height: "20"}), b = 0; b < 4; b++) {
            var d = document.createElement("div");
            a.appendChild(d)
        }
        return a.setAttribute("class", "jump-pulse"), a
    }, c["circle-turn"] = function () {
        var a = document.createElement("div"), b = c.top({width: "25", height: "25"});
        ...
        for (var a = c.top({width: "50", height: "72"}), b = 0; b < 8; b++) {
            var d = document.createElement("div");
            a.appendChild(d)
        }
        return a.setAttribute("class", "circle-fade"), a
    }, c["square-flip"] = function () {
        for (var a = c.top({width: "50", height: "0"}), b = 0; b < 1; b++) {
            var d = document.createElement("div");
            a.appendChild(d)
        }
        return a.setAttribute("class", "square-flip"), a
    }, c["line-scale"] = function () {
        for (var a = c.top({width: "60", height: "40"}), b = 0; b < 5; b++) {
            var d = document.createElement("div");
            a.appendChild(d)
        }
        return a.setAttribute("class", "line-scale"), a
        ...
        e.setAttribute("id", "_mask"), e.style.position = "fixed", e.style.top = "0", e.style.left = "0", e.style.bottom = "0", e.style.right = "0", e.style.overflow = "hidden", e.style["z-index"] = 99998, e.style["background-color"] = "#000", e.style.opacity = .6, e.style.zoom = 1, b.allowHide && e.addEventListener("click", function () {
            a.hideLoading()
        }, !1);
        var f = document.getElementsByTagName("body")[0];
        f.appendChild(e), f.appendChild(c[b.name]()), b.callback()
    }, a.hideLoading = function () {
        var a = document.getElementById("_mask"), b = document.getElementById("_loading");
        "undefined" != typeof a && null === a && "undefined" != typeof b && null === b || (a.remove(), b.remove())
    }
}(window);